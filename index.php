...
<html lang="en">
  ...
  <body id="page-top">
  	<nav class="navbar navbar-expand-lg navbar-light bg-transparent fixed-top" id="mainNav">
	  	<div class="container">
	  		<a class="navbar-brand text-danger" href="profil.php">KYNAN Motor</a>
		    ...
		    <ul class="navbar-nav ml-auto">
			    ...
			    <li class="nav-item">
			    	<a class="nav-link text-white" href="mekaniktmpl.php">Mekanik</a>
			    </li>
			    <li class="nav-item">
	...
	<div class="jumbotron">
	  <div class="container">
	  	<h1 class="display-4">Selamat Datang <br><span><img src="foto_profil/kynan7.png" alt=""></span></h1>
		<hr class="my-4">
		<p class="lead">Percayakan sepeda motor anda dan kami akan memberi yang terbaik untuk anda.</p>
